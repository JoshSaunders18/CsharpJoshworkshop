...
//student called Bruce Wayne & Selina Kyle
...
//string outputForBatman = $"Study Hours : {BruceWayne.StudyHoursPerWeek} Number of Weeks Completed : {BruceWayne.StudyWeeksCompleted}";

//string outputForCatwoman = $"Study Hours : {SelinaKyle.StudyHoursPerWeek} Number of Weeks Completed : {SelinaKyle.StudyWeeksCompleted}";
...
Josh.NameOfStudent = "Josh";
Josh.StudyHoursPerWeek = 5;
Josh.StudyWeeksCompleted = 0;
...
DeveloperTesting.CalculatorDeveloperEstimate(Josh.StudyHoursPerWeek, Josh.StudyWeeksCompleted, Josh.NameOfStudent);
DeveloperTesting.DisplayDeveloperEstimate();